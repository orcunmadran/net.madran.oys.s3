      ...
      <tr>
        <td height="24" colspan="2" valign="top"><table width="100%" height="300" border="0" cellspacing="2" cellpadding="3">
          <tr>
            ...
            <td width="65%" class="anabaslik"><a href="../yonetim/index.php">Yönetim</a> &gt; Duyuru Oluştur</td>
          ...
          <tr>
            ...
            <td colspan="2" valign="top"><form name="form1" method="post" action="yayinla.php">
              <table width="100%" border="0" cellspacing="2" cellpadding="3">
                <tr>
                  <td width="12%" class="arabaslik">Yayınlayan</td>
                  <td width="2%" class="arabaslik">:</td>
                  <td width="51%" class="icyazi"><?php echo $adsoyad ?>
                ...
                <tr>
                  ...
                  <td><textarea name="alici" cols="45" rows="2" class="metinkutusu" id="alici"></textarea></td>
                ...
                <tr>
                  ...
                  <td><input name="konu" type="text" class="metinkutusu" id="konu" size="45" maxlength="100"></td>
                  </tr>
                <tr>
                  ...
                  <td class="icyazi"><table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="icyazi">:&nbsp;</td>
                      <td><input name="baslangic" type="text" class="metinkutusu" id="baslangic" onClick="GetDate(this);" size="10" readonly="readonly" /></td>
                      <td>&nbsp;-&nbsp;</td>
                      <td class="icyazi">Bitiş</td>
                      <td class="icyazi">:&nbsp;</td>
                      <td><input name="bitis" type="text" class="metinkutusu" id="bitis" onClick="GetDate(this);" size="10" readonly="readonly" />                      </td>
                    </tr>
                  </table></td>
                  </tr>
                <tr>
                  ...
                  <td valign="top" class="arabaslik">:</td>
                  <td><textarea name="icerik" cols="55" rows="7" class="metinkutusu" id="icerik"></textarea></td>
                  </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td><input name="button" type="button" class="buton" id="button" onClick="formkontrol()" value="Duyuruyu Gönder"></td>
