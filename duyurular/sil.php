...
//Duyuru Sil
$sil_tnm = $_GET['duyuruno'];
$sil_sql = sprintf
	(
	"SELECT * FROM duyuru WHERE no = '%s' AND kimlik = '%s'",
...
if($sil_toplam == 1 && isset($_GET['duyuruno']) && $_GET['duyuruno'] != NULL){
	$sil2_sql = sprintf
		(
		"DELETE FROM duyuru WHERE no = '%s'",
		mysql_real_escape_string($sil_satir['no'], $baglanti)
		);
        ...
        <td height="24" colspan="2" valign="top"><table width="100%" height="300" border="0" cellspacing="2" cellpadding="3">
          ...
          <tr>
            ...
            <td valign="top"><p class="formuyari">İşlem Tamamlanamadı</p>
              ...
              <ul>
                <li class="icyazi">Silmek istediğiniz duyuru size ait olmayabilir.</li>
                <li class="icyazi">Silmek istediğiniz duyuru daha önce sizin tarafınızdan silinmiş olabilir.</li>
                </ul>
