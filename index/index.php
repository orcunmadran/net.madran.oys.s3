...
<table width="700" height="400" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top"><table width="306" height="364" border="0" cellpadding="1" cellspacing="1">
          <tr>
            <td width="302"><div align="left"><img src="../resimler/genel/logo.gif" width="300" height="75"></div></td>
          </tr>
          <tr>
            <td><div align="left">
              <hr width="292">
          ...
          <tr>
            <td><?php echo $sistem_gorsel_01; ?></td>
          </tr>
          <tr>
            <td height="31"><span class="anabaslik">Sanal Kampüs Nedir?</span></td>
          </tr>
          <tr>
            <td class="icyaziblok">Sanal Kampüs, zamana ve bulunduğunuz yere bağlı kalmaksızın, İnternet bağlantınızın olduğu her yerden eğitim içeriklerine ulaşabileceğiniz, etkileşimli öğretim materyallerini kullanabileceğiniz, öğretim elemanları ile iletişim kurabileceğiniz bir çevrimiçi eğitim ortamıdır.</td>
          </tr>
        </table>          </td>
        <td valign="top"><table width="90%" height="249" border="0" align="right" cellpadding="1" cellspacing="1">
          <tr>
            <td width="300" height="77"><?php echo $sistem_gorsel_02; ?></td>
          </tr>
          <tr>
            <td height="4"><div align="left">
                <hr>
            </div></td>
          </tr>
          <tr>
            <td valign="top"><table width="100%" border="0" align="right" cellpadding="3" cellspacing="2">
              <tr>
                ...
                <td width="76%"><span class="anabaslik">Haberler - Duyurular - Etkinlikler </span></td>
