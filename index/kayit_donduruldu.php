...
<table width="700" height="400" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2" valign="top"><table width="309" border="0" cellpadding="3" cellspacing="2">
          ...
          <tr>
            <td class="icyazi">Kullanıcı kaydınız yönetim tarafından donduruldu. Şu anda sisteme giriş yapmanız mümkün değil.</td>
          </tr>
          <tr>
            <td class="icyazi">Kullanıcı kaydınız ile ilgili sorularınız için <a href="iletisim.php">iletişim formunu</a> kullanabilirsiniz.</td>
          </tr>
        </table></td>
      </tr>
    </table>
