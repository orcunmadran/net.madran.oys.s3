...
function formkontrol(){
	if( document.form1.kimlik.value == "" |
		...
		document.form1.yetki.value == "Yetki Hata" |
      ...
      <tr>
        <td height="24" colspan="2" valign="top"><table width="100%" height="325" border="0" cellspacing="2" cellpadding="3">
          <tr>
            ...
            <td class="anabaslik"><a href="../yonetim/index.php">Yönetim</a> &gt; Yeni Kullanıcı Kaydı</td>
          ...
          <tr>
            ...
            <td valign="top"><form name="form1" method="post" action="yeni_kayit_sonuc.php">
              <table width="100%" border="0" cellpadding="3" cellspacing="2">
                <tr>
                  <td nowrap class="arabaslik">Kullanıcı Adı</td>
                  <td width="3" class="arabaslik">:</td>
                  <td colspan="2"><input name="kimlik" type="text" class="metinkutusu" id="kimlik" tabindex="1" size="20" maxlength="20">
                      <img src="../resimler/simge/form_uyari.gif" width="12" height="12"> </td>
                </tr>
                <tr>
                  <td nowrap class="arabaslik">Şifre</td>
                  <td class="arabaslik">:</td>
                  <td nowrap><input name="sifre" type="text" class="metinkutusu" id="sifre" tabindex="2" size="20" maxlength="20">                    <img src="../resimler/simge/form_uyari.gif" width="12" height="12"></td>
                ...
                <tr>
                  ...
                  <td class="arabaslik">:</td>
                  <td colspan="2"><input name="ad" type="text" class="metinkutusu" id="ad" tabindex="4" size="30" maxlength="40">
                      <img src="../resimler/simge/form_uyari.gif" width="12" height="12"></td>
                </tr>
                <tr>
                  <td nowrap class="arabaslik">Soyad</td>
                  <td class="arabaslik">:</td>
                  <td colspan="2"><input name="soyad" type="text" class="metinkutusu" id="soyad" tabindex="5" size="30" maxlength="40">
                      <img src="../resimler/simge/form_uyari.gif" width="12" height="12"></td>
                </tr>
                <tr>
                  ...
                  <td colspan="2"><select name="yetki" class="metinkutusu" id="yetki">
                    <option value="Yetki Hata">Seçiniz</option>
                ...
                <tr>
                  ...
                  <td class="arabaslik">:</td>
                  <td colspan="2"><input name="eposta" type="text" class="metinkutusu" id="eposta" tabindex="6" size="40" maxlength="50">
                      <img src="../resimler/simge/form_uyari.gif" width="12" height="12"></td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="arabaslik">:</td>
                  <td colspan="2"><input name="web" type="text" class="metinkutusu" id="web" tabindex="8" value="http://" size="40" maxlength="50"></td>
                </tr>
                <tr>
