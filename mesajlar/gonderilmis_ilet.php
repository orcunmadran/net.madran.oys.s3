      ...
      <tr>
        <td height="24" colspan="2" valign="top"><table width="100%" height="300" border="0" cellspacing="2" cellpadding="3">
          <tr>
            ...
            <td width="49%" class="anabaslik"><a href="index.php">Mesajlar</a> &gt; Gönderilmiş Mesajı İlet </td>
            ...
            <td colspan="2" valign="top"><form name="form1" method="post" action="gonder.php">
              <table width="100%" border="0" cellspacing="2" cellpadding="3">
                ...
                <tr>
                  ...
                  <td><input name="konu" type="text" class="metinkutusu" id="konu" value="İlet: <?php echo $mesaj_satir['konu']; ?>" size="50" maxlength="100"></td>
                  </tr>
                <tr>
...
Orjinal Mesaj
------------------
Gönderen: <?php echo $adsoyad; ?>

Alıcı: <?php echo $mesaj_satir['alici']; ?>
