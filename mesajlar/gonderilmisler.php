      ...
      <tr>
        <td height="24" colspan="2" valign="top"><table width="100%" height="325" border="0" cellspacing="2" cellpadding="3">
          <tr>
            ...
            <td width="49%" class="anabaslik"><a href="index.php">Mesajlar</a> &gt; Gönderilmiş Mesajlar (<?php echo $tms_toplam ?>) </td>
          ...
          <tr>
            ...
            <tr>
                ...
                <a href="gonderilmisler.php?goster=<?php echo $geri ?>">Sonraki mesajlar</a>
                <?php } ?>
                ...
                ?>
                <a href="gonderilmisler.php?goster=<?php echo $ileri ?>">Önceki mesajlar</a>
                <?php } ?>                </td>
                </tr>
			</table></td>
            <td valign="top">&nbsp;</td>
