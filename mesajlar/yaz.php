      ...
      <tr>
        <td height="24" colspan="2" valign="top"><table width="100%" height="300" border="0" cellspacing="2" cellpadding="3">
          <tr>
            ...
            <td width="49%" class="anabaslik"><a href="index.php">Mesajlar</a> &gt; Mesaj Yaz</td>
            ...
            <td colspan="2" valign="top"><form name="form1" method="post" action="gonder.php">
              <table width="100%" border="0" cellspacing="2" cellpadding="3">
                ...
                <tr>
                  ...
                  <td><textarea name="alici" cols="40" rows="2" class="metinkutusu" id="alici"><?php echo $alici; ?></textarea></td>
                  <td colspan="2" rowspan="5" valign="top"><select name="adresdefteri" size="12" class="adresdefteri" id="adresdefteri" onClick="adresekle()">
                  ...
                  <?php } ;?>
                  </select>                  <div align="center"><span class="icyazi">Mesaj göndermek istediğiniz<br>
                    kişi / kişileri seçiniz.</span></div></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td valign="top" class="arabaslik">:</td>
                  <td valign="top"><textarea name="icerik" cols="50" rows="7" class="metinkutusu" id="icerik"></textarea></td>
                  </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
