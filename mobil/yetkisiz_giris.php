...
<table width="700" height="400" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2" valign="top"><table width="309" border="0" cellpadding="3" cellspacing="2">
          ...
          <tr>
            <td class="icyazi">Bu sayfayı görüntüleyebilmeniz için sisteme giriş yapmanız gerekmektedir.</td>
          </tr>
          <tr>
            <td class="icyazi">Sisteme giriş yapmak için <a href="index.php">tıklayınız</a>.</td>
          </tr>
        </table></td>
      </tr>
    </table>
