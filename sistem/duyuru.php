...
$duyuru_sql = sprintf(
	"SELECT D.*, DATE_FORMAT(D.baslangic, '%%d.%%m.%%Y') AS tbaslangic, DATE_FORMAT(D.bitis, '%%d.%%m.%%Y') AS tbitis, CONCAT(K.ad, ' ', K.soyad) AS yadsoyad
	 ...
	 WHERE  D.kimlik = K.kimlik AND D.no = '%s' AND (D.alici LIKE('%%[%s]%%') OR D.alici LIKE('%%[%s]%%') OR D.alici LIKE('%%[%s]%%'))",
      ...
      <tr>
        <td height="24" colspan="2" valign="top"><table width="100%" height="325" border="0" cellspacing="2" cellpadding="3">
          <tr>
            ...
            <td width="74%" class="anabaslik">Duyuru Görüntüle</td>
            <td width="16%" nowrap class="icyazi"><table border="0" cellspacing="2" cellpadding="2">
              <tr class="icyazi">
                <td><a href="arsiv.php"><img src="../resimler/mesaj/arsiv.gif" alt="DUYURU ARŞİVİ" width="16" height="15" border="0"></a></td>
                <td nowrap><a href="arsiv.php">Duyuru Arşivi</a><a href="../duyurular/olustur.php"></a></td>
                </tr>
            </table></td>
          ...
          <tr>
            ...
            <td colspan="2" valign="top" class="anabaslik"><table width="100%" border="0" cellspacing="2" cellpadding="3">
              <tr>
                ...
                <td valign="top" class="icyazi"><?php echo $duyuru_satir['yadsoyad'] ?></td>
              ...
              <tr valign="top">
                ...
                <td class="icyazi"><span class="icyazi"><?php echo $duyuru_satir['alici'] ?></span></td>
                </tr>
              <tr valign="top">
                <td class="arabaslik">Konu</td>
                <td class="arabaslik">:</td>
                <td class="icyazi"><?php echo stripslashes($duyuru_satir['konu']) ?></td>
                </tr>
              <tr valign="top">
                <td nowrap class="arabaslik">Yayın Aralığı </td>
                <td class="arabaslik">:</td>
                <td class="icyazi"><?php echo $duyuru_satir['tbaslangic'] ?> - <?php echo $duyuru_satir['tbitis'] ?><a href="../duyurular/guncelle.php?duyuruno=<?php echo $duyuru_satir['no']; ?>"></a><a href="../duyurular/sil.php?duyuruno=<?php echo $duyuru_satir['no']; ?>" onClick="return confirm('Duyuru kalıcı olarak silinecektir.')"></a></td>
                </tr>
              <tr>
                <td class="arabaslik">&nbsp;</td>
                <td class="arabaslik">&nbsp;</td>
                <td class="icyazi"><hr class="cizgi"></td>
                </tr>
              <tr>
                <td class="arabaslik">&nbsp;</td>
                <td class="arabaslik">&nbsp;</td>
