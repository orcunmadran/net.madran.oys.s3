...
define('THIS_DIR2', dirname(__FILE__) . '/');

require_once THIS_DIR2 . "../../../temp/bot/programe/src/botinst/dbprefs.php";

/**
* The matching engine functions of the AIML interpreter.
*/
require_once THIS_DIR2 . "graphnew.php";

/**
* A collection of generally useful utility functions
*/
require_once THIS_DIR2 . "util.php";

/**
* The file containing the function that process custom, non AIML 1.0.x specified, tags.
*/
require_once THIS_DIR2 . "plugins/customtags.php";
