<?php
	...
	class ChatServer
	{
		...
		function login($login, $password, $args = array(),$session_inst=1)
		{ // changed on 090706 for chat instances
			...
			else
			{
				...
				$GLOBALS['curruserid'][$GLOBALS['clientId']] = $GLOBALS['fc_config']['cms']->login(addslashes($login), $password, $session_inst);// changed on 090706 for chat instances
		...
		function getUserProfile($userid,$session_inst = 1)
		{
			ChatServer::loadCMSclass();
