...
By Paul M - this CMS file is For vBulletin 3.0 and Flashchat 4.5.4 (or above).
...
1.14 - Added ability to login direct to a room using ../flashchat.php?username=_int_&room=n
1.15 - Changes to User and Role Caching to fix minor irritations. Change to config data loading.
