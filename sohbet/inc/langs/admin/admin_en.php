<?php
	$GLOBALS['fc_config']['languages_admin']['en'] = array(
		...
		'bot.tpl' => array(
			...
			't13' => 'The bot could not be added because the bot installation was skipped in the Flash Chat installer.',
		...
		'botlist.tpl' => array(
			...
			't3' => 'Delete',
			't4' => 'No bots found',
			't5' => 'The bot feature is currently disabled. To enable bot support, set "Enable Bots" to "Yes" in the "General Settings" configuration section of this admin panel.',
		...
		'logout.tpl' => array(
			't0' => 'FlashChat Admin Panel Logout',
...
',
		...
		'cnf_conn' => array(
			...
			't24' => array(
				...
				'hint' => 'in seconds, if a user has FlashChat open for (inactivityInterval) seconds'
			),
		...
		'cnf_general' => array(
			...
			't10' => array(
				...
				'hint' => 'set to false to allow self popup menu'
			),

			't11' => array(
				'value' => 'Allow confirmation popup window for admin (moderator):',
				'hint' => 'set to true to allow confirmation popup window for admin (moderator)'
			),
			...
			't17' => array(
				'value' => 'Moderators Restrictions in admin section:',
			...
			't30' => array(
				'value' => 'List order:',
				'hint' => 'options: Alphabetical, A to Z, Order by entry to room, Mods & Admins first, then A to Z, Mods & Admins first, then by entry, Order by user status, Mods & Admins first, then by user status'
			),

			't31' => array(
				'value' => 'CMS system:',
				'hint' => 'defaultCMS - default CMS, blank - stateless CMS'
			),
			...
			't33' => array(
				...
				'hint' => 'option to encrypt user password for defaultCMS, can be 1 - encrypt and 0 - no encrypt'
			),
			...
			't36' => array(
				'value' => 'Admin Password:<br>only applicable if Stateless (Guest) CMS is used',
		...
		'cnf_logout' => array(
			...
			't842' => array(
				'value' => 'Redirect URL:',
				'hint' => 'redirectURL must be a valid URL'
			),

			't843' => array(
				'value' => 'URL:',
				'hint' => 'redirect must be set to Yes for this to work'
			),
