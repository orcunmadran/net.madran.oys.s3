	...
	$GLOBALS['fc_config']['languages']['en'] = array(
		...
		'dialog' => array(
			...
			'common' => array(
				...
				'size_too_big'       => 'The file that you have attempted to share exceeds the maximum allowed file size MAX_SIZE bytes. Please try again.',
			),
			...
			'loadavatarbg' => array(
				...
				'file_info'  => ' Allowed File Types: ALLOWED_EXT',
			...
			'loadphoto' => array(
				...
				'file_info'  => 'Your file should be a ALLOWED_EXT',
			),
		),
